...
public class SinhalaNoun implements SinhalaSynset {
	...
	public SinhalaNoun(String eWNId,List<SinhalaWord> words,List<SinhalaSencePointer> sencePointers,String gloss) {
		super();
		this.eWNId = eWNId;
		this.words = words;
